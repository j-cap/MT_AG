...
3. matched seeds using the Algorithm-1/post-turn propagation convention;
4. structured initialization control on matched seeds;
5. particle-count sensitivity to select a practical conventional-PF reference for P1F-B.
