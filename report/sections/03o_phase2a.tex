...
\begin{itemize}
    ...
    \item \textbf{P2C -- link selection (next):} At equal numbers of UWB exchanges, compare uniform or random scheduling with geometry- and information-aware choices of which pair to range.
    \item \textbf{P2D -- reliability:} Test packet loss, burst outages, range outliers, and NLOS-like positive bias. Evaluate measurement reliability separately from the initial scheduling comparison.
