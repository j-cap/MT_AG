...
\begin{itemize}
    ...
    \item \textbf{P2B -- uniform rate sweep (next):} Reduce the update rate of all six links together, for example from \SI{10}{Hz} to \(5,2,1,0.5\) Hz, to measure the first error-versus-communication curve.
    \item \textbf{P2C -- link selection:} At equal numbers of UWB exchanges, compare uniform or random scheduling with geometry- and information-aware choices of which pair to range.
