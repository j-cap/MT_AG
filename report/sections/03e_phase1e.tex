...
\subsection{P1E audit visualization}
Figure~\ref{fig:p1e_result} summarizes the role of P1E in the research chain. The source paper is first separated into source-specified behavior and underspecified choices; the latter are fixed in an explicit repository contract before literal-small evaluation, tuning, negative controls, stress tests, and the later scalable adaptation.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.98\textwidth]{figures/phase1/p1e_reproduction_architecture.pdf}
    \caption{P1E reproduction architecture: source formulation, identified ambiguities, repository interpretation contract, and the resulting evaluation sequence.}
    \label{fig:p1e_result}
\end{figure}
