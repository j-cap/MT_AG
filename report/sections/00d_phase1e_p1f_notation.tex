...
$\Delta\mathrm{RMSE}_{p,\mathrm{late}}$ & P1F-D paired difference in late-window position RMSE, defined as AACOPF minus conventional PF for the same seed and particle budget.\\
$\Delta\mathrm{RMSE}_{\phi,\mathrm{late}}$ & P1F-D paired difference in late-window yaw RMSE, defined as AACOPF minus conventional PF for the same seed and particle budget.\\
\bottomrule
\end{longtable}
