...
$c_\lambda$ & Candidate-count-normalized transition-threshold factor defined by $c_\lambda=\lambda K_i$.\\
...
$W_{\mathrm{mode},k}$ & Posterior probability mass contained in the diagnostic correct-mode region at sample $k$.\\
