...
\subsection{P1F-A result visualization}
Figure~\ref{fig:p1fa_result} emphasizes the main P1F-A boundary. Increasing the global particle population improves the aggregate result at high populations but remains stochastic and non-monotonic, while all tested initial clouds contain diagnostic correct-region support. Presence of useful particles is therefore not sufficient; their survival and selection matter.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.98\textwidth]{figures/phase1/p1fa_global_pf_scaling.pdf}
    \caption{P1F-A conventional paper-state PF. (a) Late position RMSE and strict pose-success fraction versus global particle count. (b) Initial-support presence versus final strict pose success at $N_p=10{,}000$.}
    \label{fig:p1fa_result}
\end{figure}
